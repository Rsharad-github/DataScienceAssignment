...
data = load_iris()
# The dataset contains information about three types of iris flowers (setosa, versicolor, virginica) and their features:
# Sepal length.
# Sepal width.
# Petal length.
# Petal width.
...
y = data.target#y is a 1D array containing integers: 0, 1, and 2, representing the three flower species.
